...
rexpose package were introduced here in hope of characterization more easily. But it seemed like too rigid to be applied to datasets containing both continuous and categorical variables. So I just dealwith continuous exposome with this package.
